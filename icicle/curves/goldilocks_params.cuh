#pragma once
#ifndef GOLDILOCKS_PARAMS_H
#define GOLDILOCKS_PARAMS_H
...
namespace goldilocks {
  struct fp_config {
    ...
    static constexpr storage<limbs_count> modulus_2 = {0x00000002, 0xfffffffe};
    static constexpr storage<limbs_count> modulus_4 = {0x00000004, 0xfffffffc};
    ...
    static constexpr storage<2 * limbs_count> modulus_squared_2 = {0x00000002, 0xfffffffc, 0x00000005, 0xfffffffc};
    static constexpr storage<2 * limbs_count> modulus_squared_4 = {0x00000004, 0xfffffff8, 0x0000000b, 0xfffffff8};

    static constexpr storage<limbs_count> m = {0xffffffff, 0x00000000};
  ...
  static constexpr storage<fq_config::limbs_count> g1_gen_x = {0x00000001, 0x00000000};
  static constexpr storage<fq_config::limbs_count> g1_gen_y = {0x00000002, 0x00000000};
  static constexpr storage<fq_config::limbs_count> g2_gen_x_re = {0x00000003, 0x00000000};
  static constexpr storage<fq_config::limbs_count> g2_gen_x_im = {0x00000004, 0x00000000};
  static constexpr storage<fq_config::limbs_count> g2_gen_y_re = {0x00000005, 0x00000000};
  static constexpr storage<fq_config::limbs_count> g2_gen_y_im = {0x00000006, 0x00000000};

  static constexpr storage<fq_config::limbs_count> weierstrass_b = {0x00000003, 0x00000000};
  static constexpr storage<fq_config::limbs_count> weierstrass_b_g2_re = {0x00000001, 0x00000000};
  static constexpr storage<fq_config::limbs_count> weierstrass_b_g2_im = {0x00000002, 0x00000000};
} // namespace goldilocks
